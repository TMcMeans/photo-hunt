  ...
  let mockPhotos = [
    {
      ...
      links: {
        ...
        download_location:
          'https://api.unsplash.com/photos/VsO7V8F5jKM/download'
      },
      categories: [],
      sponsored: false,
      sponsored_by: null,
      ...
      user: {
        ...
        links: {
          ...
          portfolio:
            'https://api.unsplash.com/users/sherlockholmes26/portfolio',
          following:
            'https://api.unsplash.com/users/sherlockholmes26/following',
...
//test data 1. photos 2. query
//test fetchPhotos method
