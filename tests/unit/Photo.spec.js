...
describe('Photo', () => {
  it('should render a snapshot correct data passed in', () => {
  ...
  it('should have a prop of photo (object) when component is mounted', () => {
    const wrapper = mount(Photo, {
      propsData: {
        photo: mockPhoto
      },
    ...
    expect(wrapper.props().photo).toEqual(mockPhoto);
  });
});
